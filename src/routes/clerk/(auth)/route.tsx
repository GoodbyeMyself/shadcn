    ...
    <div className='relative container grid h-svh flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0'>
      <div className='relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-e'>
        ...
        <div className='relative z-20 mt-auto'>
          <blockquote className='space-y-2'>
            <p className='text-lg'>&ldquo; {t('authLayout.quote')} &rdquo;</p>
            <footer className='text-sm'>{t('authLayout.author')}</footer>
          </blockquote>
        </div>
      </div>
      <div className='lg:p-8'>
        <div className='relative mx-auto flex w-full flex-col items-center justify-center gap-4'>
          ...
          >
            {t('authLayout.learnMore.welcome')} <br />
            {t('authLayout.learnMore.backTo')}{' '}
            <Link
              to='/'
              className='underline decoration-dashed underline-offset-2'
            >
              {t('authLayout.learnMore.dashboard')}
            </Link>{' '}
            {t('authLayout.learnMore.question')}
          </LearnMore>
          <Outlet />
        </div>
      </div>
